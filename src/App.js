...
// ID สำหรับเชื่อมต่อระบบหลังบ้าน (Google Sheets)
...
export default function App() {
      ...
      <div style={{ textAlign: 'center', padding: '60px 20px', backgroundColor: '#fff', minHeight: '100vh', fontFamily: 'sans-serif' }}>
        ...
        <div style={{ maxWidth: '300px', margin: '0 auto' }}>
          <input 
            ...
            style={{ width: '100%', padding: '15px', marginBottom: '15px', borderRadius: '10px', border: '1px solid #000', textAlign: 'center', fontSize: '18px', boxSizing: 'border-box' }} 
          />
          <input 
            type="password" 
            ...
            style={{ width: '100%', padding: '15px', marginBottom: '25px', borderRadius: '10px', border: '1px solid #000', textAlign: 'center', fontSize: '18px', boxSizing: 'border-box' }} 
          />
          <button 
            onClick={handleLogin} 
  ...
  return (
    <div style={{ textAlign: 'center', padding: '50px', fontFamily: 'sans-serif' }}>
      ...
      <p>ยินดีต้อนรับ: <strong>{loggedInUser}</strong></p>
